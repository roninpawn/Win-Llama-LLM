...
ConfigFile := "Z:\AI\LLM_Config.ini"
...
DefaultModel := ConfigRead("General","DefaultModel","Ornith")
LastModel := ConfigRead("General","LastModel",DefaultModel)
...
if !Models.Has(InitialModelKey)
    InitialModelKey := ModelList[1]
...
CloseConsoleViewer(*) {
	...
	ConfigWrite("General","ConsoleRefreshRate",ConsoleEffectiveRate)
